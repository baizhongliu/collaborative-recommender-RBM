...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 13 16:37:44 2018
...
##################---1m---###############################
    ...
    training_set = torch.FloatTensor(dataset.convert(R_train.as_matrix()))
    test_set = torch.FloatTensor(dataset.convert(R_test.as_matrix()))
